...
\def\xxchapitre{\hspace{.12cm} Étude des performances des systèmes complexes 
...
\textit{DMU 60 eVo Linear -- Centre d'usinage 5 axes continus [1]}%\cite{cite1}}  
 
\includegraphics[width=5cm]{images/schemabloc}

\textit{Schéma bloc d'un axe numérique asservi [2]}%\cite{cite2}}

\end{center}
}%figues de la page de garde
\def\xxpied{%
Partie 2 -- Découverte des SLCI\\
Ch. 6 : Étude des performances des systèmes complexes -- Précision -- Stabilité -- \xxactivite%
}
